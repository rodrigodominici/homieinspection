          ...
          <>
            ...
            <div className="border rounded-xl overflow-auto">
              <div className="grid grid-cols-[60px_repeat(7,1fr)] min-w-[900px]">
                ...
                {HOURS.map((hour) => (
                  <>
                    <div key={`label-${hour}`} className="border-b border-r p-1 text-tiny text-muted-foreground text-right pr-2 h-16 flex items-start justify-end pt-1">
                      {hour}:00
                    </div>
